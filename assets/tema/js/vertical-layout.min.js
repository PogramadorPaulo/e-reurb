...
$(document).ready(function () {
    $("#pcoded").pcodedmenu({
        ...
        ActiveItemBackground: 'theme11', // theme1, theme2, theme3, theme4, theme5, theme6, theme7, theme8, theme9, theme10, theme11, theme12  mennu active item color
        ...
        SubItemBorder: true,
        DropDownIconStyle: 'style2', // Value should be style1,style2,style3
