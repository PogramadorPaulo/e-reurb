...
$sql = $db->prepare(
    "UPDATE confrontantes SET 
	 tipo_pessoa=:tipo, con_identificado=:con_identificado, cpf=:cpf, cnpj=:cnpj, i_estadual=:i_estadual, i_municipal=:i_municipal, 
...
if ($sql->rowCount() > 0) {
    ...
    $atividade->bindValue(":atividade_name", 'Editado confrontante: ' . $nome);
    $atividade->execute();
