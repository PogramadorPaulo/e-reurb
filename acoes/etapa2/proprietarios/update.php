...
$sql = $db->prepare(
    "UPDATE tb_matriculasproprietarios SET 
	 tipo_pessoa=:tipo, identificado=:identificado, cpf=:cpf, cnpj=:cnpj, i_estadual=:i_estadual, i_municipal=:i_municipal, 
...
if ($sql->rowCount() > 0) {
    ...
    $atividade->bindValue(":atividade_name", 'Editado proprietário da matrícula: ' . $nome);
    $atividade->execute();
