...
$idEtapa = 5; // Alterado para etapa 5
...
$totalStatement->bindValue(':id', $id, PDO::PARAM_STR);
$totalStatement->bindValue(':etapa', $idEtapa, PDO::PARAM_STR);
if (!empty($queryParam)) {
...
if ($total_data > 0) {
  ...
  foreach ($result as $row) {
    ...
    if ($canDelete) {
      $output .= '
                              <button class="btn delete-document-etapa5" id="delete-document" 
                    title="Excluir" 
