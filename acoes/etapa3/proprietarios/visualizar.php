				...
				<fieldset class="border p-3 mb-3">
					...
					<div class="custom-radio-group mt-2">
						<label class="custom-radio">
							<input type="radio" name="identificacao" value="Identificado" id="fisicaConfrontante" ' . (($row["tab_identificado"] == 'Identificado') ? 'checked' : '') . '>
							<span class="radio-btn">Identificado</span>
						</label>
						<label class="custom-radio">
							<input type="radio" name="identificacao" value="Não Identificado" id="naoIdentificado" ' . (($row["tab_identificado"] == 'Não Identificado') ? 'checked' : '') . '>
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<select class="form-control" name="estado_civil" id="estado_civil">
						<option class="" ' . (($row["estado_civil"] == 'Solteiro') ? 'selected' : '') . ' value="Solteiro">Solteiro</option>
						<option class="" ' . (($row["estado_civil"] == 'Casado') ? 'selected' : '') . ' value="Casado">Casado</option>
						<option class="" ' . (($row["estado_civil"] == 'Divorciado') ? 'selected' : '') . ' value="Divorciado">Divorciado</option>
						<option class="" ' . (($row["estado_civil"] == 'Viúvo') ? 'selected' : '') . ' value="Viúvo">Viúvo</option>
					</select>
				</div>
			</div>
